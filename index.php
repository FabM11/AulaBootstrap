...
if( isset($_SESSION['logado']) ){/*isset pergunta se algo existe*/
...
<?php
include_once('./partials/header.php');/*ele avisa se não achou o arquivo*/
/*só include não avisa se não achou o problema é seu*/
/*require_once para o código*/
?>
...
Moral da história? - Não tem moral nenhuma! Foi de sacanagem mesmo... E vê se atende o telefone educadamente, pois posso ser eu ligando para você por engano...</pre>
<?php
